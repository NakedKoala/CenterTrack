...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--lr', type=float, default=1.25e-4 / 8, 
    ...
    self.parser.add_argument('--batch_size', type=int, default=32 // 8,
                             help='batch size')
    ...
    self.parser.add_argument('--raft', type=bool, default=True)
